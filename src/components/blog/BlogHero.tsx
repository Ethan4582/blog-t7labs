      ...
      <section className="pt-20 pb-20 px-10">
         ...
         >
            <h1 className="text-xl md:text-2xl font-bold text-foreground/90 mb-8 tracking-tight leading-relaxed font-serif line-clamp-2 max-w-full">
               Welcome to my blog <span className="inline-block scale-125 opacity-70">✋</span> I'm <span className="text-primary font-black">Ashirwad</span> and here I document my latest explorations.
            </h1>
